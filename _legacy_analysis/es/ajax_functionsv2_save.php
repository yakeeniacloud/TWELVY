...
function update_sous_cat_etat_permis($new_etat_permis, $id_stagiaire, $echo) {
    ...
    if(count($tmp) == 3 && checkdate($tmp[1], $tmp[2], $tmp[0])){
        ...
        $date_permis_format = "<span style='color:red'>Non renseigné</span>";
    ...
    $c = '
        <div class="row rv1">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Votre permis est</div>
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#" data-name="stagiaire|etat_permis" id="etat_permis" data-type="select" data-pk="'.$id_stagiaire.'" data-value="'.$etat_permis.'" data-title="Select status"></a></div>
        </div>
    ';
	 switch ($new_etat_permis) {
		case 1:
            $c .= '
              <div class="row rv1">
                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Type de permis</div>
                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#" data-name="stagiaire|type_permis" id="type_permis" data-type="select" data-pk="'.$id_stagiaire.'" data-value="'.$type_permis.'"></a></div>
              </div>
              <div class="row rv1">
                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Numéro de permis <span id="cb_numero_span" class="glyphicon glyphicon-info-sign" aria-hidden="true" style="cursor:pointer" onClick="PictureDisplay();"></span></div>
                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-name="stagiaire|num_permis" class="editable_text" data-pk="'.$id_stagiaire.'" id="mlink13">'.$num_permis.'</a></div>
              </div>
              <div class="row rv1">
                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Date de délivrance  <span id="cb_numero_span" class="glyphicon glyphicon-info-sign" aria-hidden="true" style="cursor:pointer" onClick="PictureDisplay();"></span></div>
                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-value="'.$date_permis.'" data-type="combodate" data-name="stagiaire|date_permis" class="editable_date" data-pk="'.$id_stagiaire.'" id="mlink14">'.$date_permis_format.'</a></div>
              </div>
              <div class="row rv1">
                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Préfécture de délivrance</div>
                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-value="'.$lieu_permis.'" data-name="stagiaire|lieu_permis" class="editable_text" data-pk="'.$id_stagiaire.'" id="mlink15">'.$lieu_permis.'</a></div>
              </div>
              <div class="row rv1">
                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Nombre de points restant</div>
                  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-name="stagiaire|points_restant" id="points_restant" data-type="select" data-pk="'.$id_stagiaire.'" data-value="'.$points_restant.'"></a></div>
              </div>
            ';
		break;
		case 2:
		...
		case 6:
            $c .= '
                <div class="row rv1">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Numéro de permis <span id="cb_numero_span" class="glyphicon glyphicon-info-sign" aria-hidden="true" style="cursor:pointer" onClick="PictureDisplay();"></span></div>
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-name="stagiaire|num_permis" class="editable_text" data-pk="'.$id_stagiaire.'" id="mlink16">'.$num_permis.'</a></div>
                </div>
                <div class="row rv1">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Date de délivrance du permis  <span id="cb_numero_span" class="glyphicon glyphicon-info-sign" aria-hidden="true" style="cursor:pointer" onClick="PictureDisplay();"></span></div>
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-value="'.$date_permis.'" data-type="combodate" data-name="stagiaire|date_permis" class="editable_date" data-pk="'.$id_stagiaire.'" id="mlink17">'.$date_permis.'</a></div>
                </div>
                <div class="row rv1">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Préfécture de délivrance</div>
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-value="'.$lieu_permis.'" data-name="stagiaire|lieu_permis" class="editable_text" data-pk="'.$id_stagiaire.'" id="mlink18">'.$lieu_permis.'</a></div>
                </div>
                <div class="row rv1">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Etes vous conducteur en permis probatoire ?</div>
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-name="stagiaire|permis_probatoire" id="permis_probatoire" data-type="select" data-pk="'.$id_stagiaire.'" data-value="'.$permis_probatoire.'"></a></div>
                </div>
                <div class="row rv1">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 nolrp">Nombre de points restant</div>
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 nolrp"><a href="#"" data-name="stagiaire|points_restant" id="points_restant" data-type="select" data-pk="'.$id_stagiaire.'" data-value="'.$points_restant.'"></a></div>
		...
		case 4:
            $c .= '
                <div class="row rv1">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 nolrp">Avez-vous receptionne la lettre recommandee reference 48SI<br>(permis invalide pour solde nul) ?</div>
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 nolrp">
                        <div class="row rv1">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-4 nolrp"></div>
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-xs-8 nolrp">
                                <a href="#"" data-name="stagiaire|reception_48SI" id="reception_48SI" data-type="select" data-pk="'.$id_stagiaire.'" data-value="'.$reception_48SI.'"></a>
                            </div>
                        </div>
                    </div>
                </div>
...
function espace_stagiaire_telechargement_documents($id_stagiaire, $reload=false) {
	...
	$md5 = substr($md5, 0, 10);
	$src = "https://www.prostagespermis.fr/stages/telechargement_documentsv2.php?id=".$id_stagiaire."&k=".$md5."&preventcache=".$time;

	$c = "";

	$c .= "<div style='overflow: hidden;'>
		<iframe id='iframe_telechargement_documents' scrolling='no' src='$src' style='border: 0px none; margin-left: 0px; margin-top: 0px; width: 100%; height:250px;'>
		</iframe>
		</div>";
