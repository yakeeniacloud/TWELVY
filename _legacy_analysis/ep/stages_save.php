...
if (isset($_SESSION['membre'])) { ?>
	...
	<div class="col-md-10 col-xs-12 col-md-offset-1">
		...
		<a class="btn btn-green btn-add pull-right ls-modal" href='popup_ajouter_stage2.php'>AJOUTER UN STAGE</a>
		</div>
        ...
        <script>
            ...
            function validateCGP(id_membre)
            {
                $.ajax({
                    ...
                    data: {action: 'validateCGP', id_membre: <?= $membre ?> },
                    type: 'POST',
                    success: function (output) {
            ...
            {
                $.ajax({ url: 'ajax_functions.php',
                    data: {action: 'check_if_user_has_accepted_CGP', id_membre: <?= $membre ?> },
                    type: 'POST',
                    success: function(output) {
