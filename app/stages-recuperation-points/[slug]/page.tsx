      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-center gap-8 mb-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-700">Agréé Préfecture</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-700">+ 4 points en 48h</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-700">Prix le plus bas garanti</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-700">14 jours pour changer d'avis</span>
          </div>
        </div>

        {/* Prefecture Badge */}
        <div className="flex items-center justify-center gap-3 bg-[#c4cce1] rounded-xl px-6 py-2 mb-6 w-fit mx-auto">
          <div className="w-6 h-6 bg-blue-600 rounded flex items-center justify-center">
            <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <span className="text-sm text-gray-800">Stages Agréés par la Préfecture des Bouches-du-Rhône (13)</span>
        </div>
          ...
          <>
            {visibleStages.map((stage) => {
              ...
              return (
                <article
                  key={stage.id}
                  className={`flex items-center justify-between p-4 mb-3 rounded-lg border border-gray-300 shadow-sm ${
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{stage.site.ville}</p>
                      <p className="text-sm text-gray-500">{stage.site.adresse}</p>
                    </div>
                  </div>

                  <div className="text-center">
                    <p className="text-xl font-normal text-gray-900">{stage.prix}€</p>
                    {isCheapest && (
