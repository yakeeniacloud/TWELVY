...
export default function StagesResultsPage() {
  ...
  return (
    <div className="bg-white w-full min-h-screen">
      ...
      {/* Main Content */}
      <main className="max-w-5xl mx-auto px-4 md:px-4 pb-4 md:py-8" style={{ paddingTop: '11px' }}>
        <h1 className="text-lg md:text-2xl font-normal text-center" style={{ marginBottom: '7px' }}>
